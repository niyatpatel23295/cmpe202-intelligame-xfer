...
public class Level2World extends World
{
  ...
  public Level2World()
  {
    ...
    img = new GreenfootImage("waterbackground1.png");
    setBackground(img);
  ...
  public void act()
  {
    ...
    {
      trash.setFlag(false); //set flag to false after each level
      ...
      {
      setBackground(new GreenfootImage("waterbackground" + stage + ".png"));
